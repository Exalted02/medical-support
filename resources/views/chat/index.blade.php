										...
										<ul class="nav nav-tabs flex-column vertical-tabs-3" role="tablist">
										   <li class="nav-item me-0" role="presentation">
											   <a class="nav-link text-break mw-100 active" data-bs-toggle="tab" role="tab" aria-current="page" href="#employee-vertical" aria-selected="false" tabindex="-1">
												   <i class="feather-user me-2 align-middle d-inline-block"></i>Employee One
											   </a>
										   </li>
										   <li class="nav-item me-0" role="presentation">
											   <a class="nav-link text-break mw-100" data-bs-toggle="tab" role="tab" aria-current="page" href="#customers-vertical" aria-selected="false" tabindex="-1">
												   <i class="feather-user me-2 align-middle d-inline-block"></i>Employee Two
											   </a>
										   </li>
										   <li class="nav-item" role="presentation">
											   <a class="nav-link text-break mb-0 mw-100" data-bs-toggle="tab" role="tab" aria-current="page" href="#products-vertical" aria-selected="true">
												   <i class="feather-user me-2 align-middle d-inline-block"></i>Employee Three
											   </a>
										   </li>
										</ul>
									</div>
